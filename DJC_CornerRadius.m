...
//  DJC_ImageViewDemo
//
//  Created by 杜建超 on 15/3/10.
//  Copyright © 2015年 olinone. All rights reserved.
//

#import "DJC_CornerRadius.h"
...
/////////////////////////////////////////////////////////////////////
@interface DJC_ImageObserver : NSObject
...
@implementation DJC_ImageObserver
...
/////////////////////////////////////////////////////////////////////
@implementation UIImageView (DJC_CornerRadius)
...
- (DJC_ImageObserver *)imageObserver {
    DJC_ImageObserver *imageObserver = objc_getAssociatedObject(self, @selector(imageObserver));
    if (!imageObserver) {
        imageObserver = [[DJC_ImageObserver alloc] initWithImageView:self];
